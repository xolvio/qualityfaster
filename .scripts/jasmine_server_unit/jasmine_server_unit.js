...
if (!process.env.MONGO_URL) {
  process.env.MONGO_URL = 'mongodb://127.0.0.1:3001/jasmine-server';
}

var path = require('path');
var appPath = path.resolve(__dirname, path.join('..', '..', 'src'));
...
Fiber(function () {
  ...
  jasmine.loadConfig({
    ...
    spec_files: [
      'imports/**/*-spec.@(js|jsx)',
      // FIXME: Excluding files is not supported yet
      //'!imports/**/ui/**/*-spec.@(js|jsx)',
    ],
    helpers: [
      'imports/testing/_support/server/**/*.@(js|jsx)',
    ]
  });
